...
public class MouseInputs implements MouseListener, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		case PLAYERSELECTION -> gamePanel.getGame().getPlayerSelection().mouseMoved(e);
	...
	public void mousePressed(MouseEvent e) {
		...
		case PLAYERSELECTION -> gamePanel.getGame().getPlayerSelection().mousePressed(e);
	...
	public void mouseReleased(MouseEvent e) {
		...
		case PLAYERSELECTION -> gamePanel.getGame().getPlayerSelection().mouseReleased(e);
