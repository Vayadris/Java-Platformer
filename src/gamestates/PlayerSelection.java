...
public class PlayerSelection extends State implements Statemethods{
	...
	public void draw(Graphics g) {
		...
		//center
		drawCharacter(g, playerIndex, menuX + menuWidth/2, menuY + menuHeight/2);
		
		//left
		drawCharacter(g, playerIndex-1, menuX, menuY + menuHeight/2);
		
        //right
		drawCharacter(g, playerIndex+1, menuX + menuWidth, menuY + menuHeight/2);
		
	}
	
	private void drawCharacter(Graphics g, int playerIndex, int x, int y) {
		if(playerIndex < 0)
	...
	public class CharacterAnimation{
		...
		private int scale = (int)(Game.SCALE + 6);
